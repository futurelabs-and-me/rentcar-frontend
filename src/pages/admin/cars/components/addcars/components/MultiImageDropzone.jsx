...
const variants = {
  base: "relative rounded-md flex justify-center items-center flex-col cursor-pointer h-full min-h-[150px] min-w-[200px] border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out",
  image:
...
const MultiImageDropzone = React.forwardRef(
  (
    ...
    return (
      <div>
        <div className="grid grid-cols-[repeat(1,1fr)] gap-2 h-[24.5rem] no-scrollbar py-3 overflow-y-scroll">
          {/* Images */}
